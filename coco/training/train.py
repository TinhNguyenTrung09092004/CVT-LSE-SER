...
class Config:
    ...
    karpathy_json: str = "data/coco/dataset_coco.json"
    train_dir: str = "data/coco/train2014"
    val_dir: str = "data/coco/val2014"
    ...
    val_h5: str = "data/coco/features/val.h5"
    test_h5: str = "data/coco/features/test.h5"

    train_desc_csv: str = "data/coco/descriptions/coco_descs_train_scored.csv"
    val_desc_csv: str = "data/coco/descriptions/coco_descs_val_scored.csv"
    test_desc_csv: str = "data/coco/descriptions/coco_descs_test_scored.csv"
...
class DataManager:
    ...
    def _get_image_path(self, img_info: dict) -> str:
        ...
        if "train2014" in filename:
            return os.path.join(self.config.train_dir, filename)
        else:
            return os.path.join(self.config.val_dir, filename)
...
VOCAB_PATH = "outputs/coco/word2idx.json"
...
def generate_csv(epoch):
    ...
    csv_path = f"outputs/coco/beam_candidates_epoch_{epoch+1}.csv"
...
CHECKPOINT_PATH = "outputs/coco/checkpoint_latest.pt"
MODEL_PATH = "outputs/coco/model_checkpoint_epoch_{epoch}.pth"
