...
# %%
df_test = detect_and_save_csv(test_images, "TEST", os.path.join(OUTPUT_DIR, "flickr30k_test_reltr_detection.csv"))

display_sample_with_predictions(test_images, df_test, "TEST", n=20)

print("Preview flickr30k_test_reltr_detection.csv (first 20 rows):")
print(df_test.head())

# %%
df_val = detect_and_save_csv(val_images, "VAL", os.path.join(OUTPUT_DIR, "flickr30k_val_reltr_detection.csv"))

display_sample_with_predictions(val_images, df_val, "VAL", n=20)

print("Preview flickr30k_val_reltr_detection.csv (first 20 rows):")
print(df_val.head())

# %%
df_train = detect_and_save_csv(train_images, "TRAIN", os.path.join(OUTPUT_DIR, "flickr30k_train_reltr_detection.csv"))

display_sample_with_predictions(train_images, df_train, "TRAIN", n=20)

print("Preview flickr30k_train_reltr_detection.csv (first 20 rows):")
print(df_train.head())
