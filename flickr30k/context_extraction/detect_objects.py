...
df_test.to_csv(os.path.join(OUTPUT_DIR, "flickr30k_test_detection.csv"), index=False)
print("Saved: flickr30k_test_detection.csv")

print("First 20 rows of flickr30k_test_detection.csv:")
print(df_test.head())
...
df_train.to_csv(os.path.join(OUTPUT_DIR, "flickr30k_train_detection.csv"), index=False)
print("Saved: flickr30k_train_detection.csv")

print("First 20 rows of flickr30k_train_detection.csv:")
print(df_train.head())
...
df_val.to_csv(os.path.join(OUTPUT_DIR, "flickr30k_val_detection.csv"), index=False)
print("Saved: flickr30k_val_detection.csv")

print("First 20 rows of flickr30k_val_detection.csv:")
print(df_val.head())

# %%
print("=" * 70)
print("SUMMARY - Flickr30k YOLO Detection")
print("=" * 70)
